...
@FeignClient(name = "external-service-group", url = "http://45.131.42.43:9002") // URL для деплоя
public interface FeignForGroup {

    /**
     * Запрос на создание группы
     */
    @PutMapping("/api/create_group/{id}")
    void createGroup( @PathVariable("id") String id);
